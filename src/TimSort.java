...
public class TimSort {
    ...
    public static <T extends Comparable<T>> void insertionSort(List<T> list, int left,
                                                               int right) {
    ...
    public static <T extends Comparable<T>> void merge(List<T> list, int l,
                                                       int m, int r) {
    ...
    public static <T> void printArray(List<T> list, int n) {
        for (int i = 0; i < n; i++) {
